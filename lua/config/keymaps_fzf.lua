...
local exclude_opts_sp = build_exclude_opts(exclude_list_sp, "rg")
local combined_opts = exclude_opts_rg .. " " .. exclude_opts_sp
local exclude_opts_fd = build_exclude_opts(exclude_list, "fd")
